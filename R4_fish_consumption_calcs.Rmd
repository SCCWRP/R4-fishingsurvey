...
mutate(species_consumed = case_when(
...
mutate(cooking_details = case_when(
...
household_consumers_long_subset <- household_consumers_long %>%
  ...
  select(rowID, Number_in_household, Number_in_household_eating_caught_fish_including_fisher, household_member, Relation_to_fisher, age, gender, species_consumed,parts_eaten, cooking_details,  daily_intake, everything())
