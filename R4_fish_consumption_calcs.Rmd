...
###NEEDS fixing - currently counting multiple people per person because in long format
##Tommy - need to summarize so that only one row is counted per person, then check numbers with the excel sheet to see if we are getting the same thing
