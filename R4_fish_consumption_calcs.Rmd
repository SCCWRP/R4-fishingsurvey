...
path <- c("//pacific/Toxicology/tox/Risk Assessment/Region4_Urban lakes fishers survey/Survey data/Fisher_Survey_Database_2024.xlsm")
...
##verify consumer subset ## This is solely to check the code.
